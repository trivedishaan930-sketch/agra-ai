...
export class DefaultReliabilityAnalyzer implements ReliabilityAnalyzer {
  analyze(
    ...
    return {
      ...
      warnings: [],
      metadata: {
        stage: "reliability_analysis",
        sourceReliabilityChecked: false,
      },
    };
  }
}
