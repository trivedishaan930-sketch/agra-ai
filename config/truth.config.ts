...
export const truthConfig = {
  ...
  analyzers: {
    ...
    pluginRegistrationEnabled: false,
  ...
  performance: {
    ...
    enableDistributedExecution: false,
  },
  security: {
    storeSecrets: false,
  ...
  internalFramework: {
    exposeFrameworkFromPublicBarrel: false,
    exposeAnalyzerInternals: false,
    exposePipelineState: false,
    exposeDebugData: false,
    exposeResearchInternals: false,
